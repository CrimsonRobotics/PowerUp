 ...
 *
 */
public class AutoScaleLeftToRight extends CommandGroup {

    public AutoScaleLeftToRight() {
    	
    	setInterruptible(false);
    	
    	addSequential(new UpIntake());
    	addSequential(new UpIntake());
    	addSequential(new AutoDrive(12500,12500,100,1,false));
    	addSequential(new AutoDrive(-1100,1100,100,.5,false));
    	addParallel(new MoveToTop());
    	addParallel(new MoveToTop());
    	addSequential(new AutoDrive(10500,10500,100,1,false));
    	addSequential(new AutoDrive(1100,-1100,100,.5,false));
