...
public class AutoDriveCurve extends Command {
	...
	boolean willSlow;
	double angleChange;
	double angleTightness;
	
	WPI_TalonSRX encoderTalonLeft = Robot.driveTrain.bL;
	WPI_TalonSRX encoderTalonRight = Robot.driveTrain.fR;
	
    public AutoDriveCurve(int leftChange,int rightChange,int accuracy, double power, boolean willSlow, double angleChange, double angleTightness) {
    	...
    	this.angleTightness = angleTightness;
    }
    ...
    protected void initialize() {
    	...
    	targetAngle = Robot.gyro.getAngle()+angleChange;
    }
